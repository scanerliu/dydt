...
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'D:/wwwroot/pc_dtyd/certs/sd.pfx';  
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'https://dtyd.com.cn/upacp_sdk_php/FrontReceive.php';

// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL = 'https://dtyd.com.cn/upacp_sdk_php/BackReceive.php';
