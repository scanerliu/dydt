...
<div class="nav_index_banner">
  <ul class="center_nav">
    ...
    <li><a href="/shop/discount">团购</a></li>
       ...
       <div class="crumbs">
       		<a>您的位置：</a>
       		<p style="border: none;" class="crumbs02">首页</p>
       		<p class="crumbs02">金牌厂家</p>
       		<p>Gold factory</p> 
      ...
      -->
       <ul class="compan">
       		<li>
       		<?php if(is_array($gold_manu)): $i = 0; $__LIST__ = $gold_manu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__APP__/goldcontent/goldcontent/id/<?php echo ($vo['gold_id']); ?>">
       				<img src="/Uploads/<?php echo ($vo['gold_pic']); ?>"  />
