...
<div class="nav_index_banner">
  ...
  <div class="position_l">
    <p>您现在的位置：</p>
    <span>单体药店网 > <span class="news"><?php echo ($leiming["category_Name"]); ?></span> </div>
  <div class="content_list_l">
    <div class="content_list_left">
      <dt>关于单体药店网</dt>
      <dl class="list_left_dl">
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=11">行业新闻</a></dd>
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=32">疾病手册</a></dd>
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=42">药物常识</a></dd>
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=24">健身宝典</a></dd>
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=72">常见问题</a></dd>
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=73">用户协议</a></dd>
        <dd><a href="__APP__/newssmalllist/newssmalllist?id=74">关于单体</a></dd>
      </dl>
      <div class="code_list"> <img src="__PUBLIC__images/footer_mark.png" alt="">
        <p>微信关注二维码</p>
        <p>买药查价一手抓</p>
      </div>
    </div>
    <div class="content_list_right">
      <h1 class="arc_title"><?php echo ($list["gold_name"]); ?></h1>
      <p class="arc_author"><span>浏览：<?php echo ($list["browse_num"]); ?></span></p>
      <p> <?php echo ($list["gold_content"]); ?> </p>
    </div>
  </div>
 </div>
<div class="footer">
