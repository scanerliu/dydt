...
<head>
	...
	<link rel="stylesheet" href="__PUBLIC__/css/other.css">
	<link rel="stylesheet" href="__PUBLIC__/css/cssforml.css">
	<script style="text/javascript" src="__PUBLIC__/js/jquery-1.11.0.js"></script>	
	<script style="text/javascript" src="__PUBLIC__/js/rich_lee.js"></script>
</head>
  ...
  <ul class="center_nav">
    ...
    <li><a href="/shop/discount">团购</a></li>
       ...
       <div class="crumbs">
       		...
       		<h6>首页</h6>
       		<h6>查看物流</h6>
       		<p>check the logisticscheck the logistics</p>   	
       </div>
       <div class="processout">
       		<hr class="process_hr">
       		<div style="text-align:center;">
                <?php echo ($erro); ?>
    			<iframe src="<?php echo ($get_content); ?>" align="center" width="580" height="400px" frameborder="no" border="0" scrolling="no"><br/></iframe>
    		</div>
       		<hr class="process_hr">
       		<div class="process_massage">
       			<p>运单号码：
                 <span><?php echo ($order["transport_code"]); ?></span>物流公司：<span>
                 <?php if($order["transport_company"] == zhongtong): ?>中通
               <?php elseif($order["transport_company"] == yunda): ?> 韵达
               <?php elseif($order["transport_company"] == yuantong): ?> 圆通
               <?php elseif($order["transport_company"] == shunfeng): ?> 顺丰
               <?php elseif($order["transport_company"] == ems): ?> EMS<?php endif; ?> 
                  </span></p>
				<p>卖家昵称：<span>单体药店专卖网</span></p>
 				<p>收货地址： <?php echo ($order["real_address"]); ?> </p>
       		</div>
       </div>
 	</div>	
	<!--
