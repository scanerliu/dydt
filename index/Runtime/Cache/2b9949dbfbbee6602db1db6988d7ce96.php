...
<head>
<meta charset="UTF-8">
<title><?php echo ($list["title"]); ?>-<?php echo ($top_content["title"]); ?></title>
...
<div class="nav_index_banner">
  ...
  <div class="position_l">
    <p>您现在的位置：</p>
    <span>单体药店网 > <span class="news"><?php echo ($hello1["category_Name"]); ?></span> </div>
  <div class="content_list_l">
    <div class="content_list_left">
      <dt><?php echo ($hello1["category_Name"]); ?></dt>
      <dl class="list_left_dl">
 <?php if(is_array($asdsdaf)): $i = 0; $__LIST__ = $asdsdaf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol2): $mod = ($i % 2 );++$i;?><dd><a href="/newsmanu/newsmanu/id/<?php echo ($vol2["class_child_id"]); ?>"><?php echo ($vol2["category_Name"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
      </dl>
    ...
    <div class="content_list_right">
      <h1 class="arc_title"><?php echo ($list["title"]); ?></h1>
      <p class="arc_author"><span>时间：<?php echo ($list["time"]); ?></span><span>浏览：<?php echo ($list["browse_num"]); ?></span></p>
      <p> <?php echo ($list["arccontent"]); ?> </p>
    </div>
  </div>
</div>
<div class="footer">
