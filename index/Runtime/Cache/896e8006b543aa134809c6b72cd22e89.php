...
<div class="good_content">
   		...
   		<div class="team_buybox">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dl class="team_buy">
	   			<dt>
	   				<a href="/shop/content/product_id/<?php echo ($vol["product_id"]); ?>"><img src="/Uploads/<?php echo ($vol["img"]); ?>" /></a>
	   				<span>剩余时间：<?php echo ($vol["remainingTime"]); ?></span>
	   			</dt>
	   			<dd>
	   				<h3><a href="/shop/content/product_id/<?php echo ($vol["product_id"]); ?>"><?php echo ($vol["title"]); ?></a></h3>
	   				<span>￥<?php echo ($vol["price3"]); ?></span>
	   				<s>￥<?php echo ($vol["price1"]); ?></s>
                    <a href="/shop/content/product_id/<?php echo ($vol["product_id"]); ?>">马上购买</a>
	   			</dd>
