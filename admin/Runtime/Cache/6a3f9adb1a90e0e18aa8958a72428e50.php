  ...
  <tr>
    ...
    <?php if(is_array($asdsdaf)): $i = 0; $__LIST__ = $asdsdaf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
        <td height="30"><?php echo ($vol["category_Name"]); ?></td>
         <td>
         <?php if(is_array($vol["zl"])): $i = 0; $__LIST__ = $vol["zl"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol2): $mod = ($i % 2 );++$i;?><a href="__APP__/liu/manuchange/article_id/<?php echo ($vol2["class_child_id"]); ?>" style="color:#03C"><?php echo ($vol2["category_Name"]); ?></a>&nbsp; <a href="/newsmanu/newsmanu/id/<?php echo ($vol2["class_child_id"]); ?>" target="_blank">（<?php echo ($vol2["category_Name"]); ?>前端展示）</a>  &nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
         </td>
