...
<body>
 ...
 <?php if($_GET['class'] != index_ad2 ): ?><table  width="99%" border="0" cellpadding="0" cellspacing="0" style=" margin-bottom:5px;" >
    <tr style="background:url(__PUBLIC__images/a10.gif) repeat-x; height:36px;">
      <td style="text-align:right"><a href="__APP__/indexManagement/bannerAdd/class/<?php echo ($_GET['class']); ?>" class="button1">添加图片</a></td>
    </tr>
  </table><?php endif; ?>
  ...
  <table width="99%" border="0" cellpadding="0" cellspacing="0" style=" margin-bottom:5px;" >
    ...
    <tr bgcolor="#fbfce2">
     ...
     <?php if($_GET['class'] != index_ad2 ): ?><td  width="30">选择</td><?php endif; ?>
      <td width="130">缩略图</td>
      <td>链接地址;</td>
      <td width="100">操作</td>
    </tr>
    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
      ...
      <?php if($_GET['class'] != index_ad2 ): ?><td><input name="" type="checkbox" value="<?php echo ($vol["index_banner_id"]); ?>"  /><?php endif; ?></td>
      ...
      <td><a href="__APP__/indexManagement/bannerSave/index_banner_id/<?php echo ($vol["index_banner_id"]); ?>/class/<?php echo ($_GET['class']); ?>" style="color:#03C">修改</a>&nbsp;<?php if($_GET['class'] != index_ad2 ): ?><a href="__APP__/indexManagement/bannerListFunDel/id/<?php echo ($vol["index_banner_id"]); ?>/class/<?php echo ($_GET['class']); ?>" style="color:#03C">删除</a>&nbsp;<?php endif; ?><a href="/Uploads/<?php echo ($vol["img"]); ?>" target="_new" style="color:#03C">大图</a></td>
