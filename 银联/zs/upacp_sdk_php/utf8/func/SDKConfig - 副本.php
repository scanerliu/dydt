...
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'D:/wwwroot/pc_dtyd/certs/acp_test_sign.pfx';
...
const SDK_VERIFY_CERT_DIR = 'D:/wwwroot/pc_dtyd/certs/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://pc.dtyd.com.cn/upacp_sdk_php/demo/api_01_gateway/FrontReceive.php';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://pc.dtyd.com.cn/1.php';
